...
class TestOperations(AsyncTestCase):
    ...
    async def test_medianBlur(self):
        async for ctx, results in MemoryOrchestrator.run(
            ...
            [
                ...
                Input(value=[3, 3], definition=medianBlur.op.inputs["ksize"],),
            ],
        ):
            self.assertEqual(
    ...
    # async def test_get_kernel(self):
    #     async for ctx, results in MemoryOrchestrator.run(
    #         DataFlow.auto(normalize, GetSingle),
    #         [
    #             Input(
    ...
    # async def test_calcBackProject(self):
    #     async for ctx, results in MemoryOrchestrator.run(
    #         DataFlow.auto(normalize, GetSingle),
    #         [
    #             Input(
    ...
    # async def test_equalizeHist(self):
    #     async for ctx, results in MemoryOrchestrator.run(
    #         DataFlow.auto(normalize, GetSingle),
    #         [
    #             Input(
